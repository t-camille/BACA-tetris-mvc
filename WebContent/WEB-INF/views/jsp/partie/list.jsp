...
<c:if test="${ utilisateur.type == 1 }">
	<div class="fixed-action-btn">
		<a href="${ pageContext.request.contextPath }/partie/add" class="btn-floating btn-large red">
						...
						<c:if test="${ partie.joueurB == null }">
							<c:choose>
								<c:when test="${ utilisateur.id != partie.joueurA.id && utilisateur.type == 1 }">
									<a href="${ pageContext.request.contextPath }/partie/join/${ partie.id }">Rejoindre</a>
								</c:when>
